 ...
 * <ul>
 *   <li>{@link specific.emf.cpp.impl.CppOperationImpl#getVisibility <em>Visibility</em>}</li>
 *   <li>{@link specific.emf.cpp.impl.CppOperationImpl#isStatic <em>Static</em>}</li>
 *   <li>{@link specific.emf.cpp.impl.CppOperationImpl#getTypedef <em>Typedef</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class CppOperationImpl extends EOperationImpl implements CppOperation {
	/**
	...
	protected EClass eStaticClass() {
		return CppPackage.Literals.CPP_OPERATION;
	}
	...
	public void setVisibility(CppVisibility newVisibility) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CppPackage.CPP_OPERATION__VISIBILITY, oldVisibility, visibility));
	}
	...
	public void setStatic(boolean newStatic) {
		...
		static_ = newStatic;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CppPackage.CPP_OPERATION__STATIC, oldStatic, static_));
	}
	...
	public CppTypedef getTypedef() {
		if (typedef != null && typedef.eIsProxy()) {
			...
			if (typedef != oldTypedef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CppPackage.CPP_OPERATION__TYPEDEF, oldTypedef, typedef));
			}
		}
		return typedef;
	}
	...
	public void setTypedef(CppTypedef newTypedef) {
		...
		typedef = newTypedef;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CppPackage.CPP_OPERATION__TYPEDEF, oldTypedef, typedef));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CppPackage.CPP_OPERATION__VISIBILITY:
				return getVisibility();
			case CppPackage.CPP_OPERATION__STATIC:
				return isStatic();
			case CppPackage.CPP_OPERATION__TYPEDEF:
